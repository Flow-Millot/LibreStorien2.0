# Rapport Bench KoboldCpp – texte-12000 (20251016_140306)
...
|---:|----------:|------:|------:|-------:|--------:|:------|
| 1 | 35.138870 | 1870 | 1926 | 53.22 | 54.81 | `c78b137d173dac9829202e9469b9afb2cedc3d44405a6641a14da0aa28aafc45` |
| 2 | 25.027768 | 1956 | 2013 | 78.15 | 80.43 | `a24d8e3b64d1d094104e5779a0275375f4447f931e6e5641d980057e081f475b` |
| 3 | 27.272485 | 2162 | 2229 | 79.27 | 81.73 | `021f332185f1866c124b222e871609fa7ff0743a71bba80cbc8478b23da55821` |
| 4 | 30.643371 | 2505 | 2571 | 81.75 | 83.90 | `6089be64d06effd16db394600a7197ff7c354831886edc44989eec30f320bac3` |
| 5 | 26.412422 | 2098 | 2164 | 79.43 | 81.93 | `008f531ee364a26d32213fe1561f10e32a3fcb2a890af95f63538556e56baf00` |
...
```
Le texte aborde plusieurs aspects historiques et règlementaires du football, en particulier en ce qui concerne l'arbitrage et les équipements. Voici des réponses aux questions posées :

1. **Règle générale d’effectif et d’usage des mains au football, et objectif du jeu :**
   - L'effectif de base d'une équipe est de onze joueurs, avec la possibilité de faire jusqu'à trois remplacements. Les gardiens de but sont les seuls joueurs autorisés à utiliser leurs mains, mais uniquement lorsqu'ils sont dans leur surface de réparation.

2. **Codification du football et fondation de la FIFA :**
   - Le football a été codifié en 1863 avec la création de la Football Association (FA) en Angleterre. La FIFA (Fédération Internationale de Football Association) a été fondée en 1904.

3. **Réforme majeure de 1925 modifiant la règle du hors-jeu :**
   - En 1925, la règle du hors-jeu a été modifiée. Avant cette date, un joueur était en position de hors-jeu s'il se trouvait entre le dernier défenseur et le but. La réforme a introduit la notion de "ligne de hors-jeu", permettant aux joueurs d'être sur cette ligne sans être en position de hors-jeu.

4. **Pelouses artificielles en phase finale de Coupe du monde et exemple de stade :**
   - Le texte indique qu'après des modifications des tests de certification de la FIFA en 2001, il est devenu possible d'utiliser des terrains artificiels en phase finale de Coupe du monde. Bien que le Stade Loujniki à Moscou ait été équipé d'une pelouse artificielle certifiée par la FIFA en 2002, il a été équipé d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008, illustrant que, bien que possible, l'utilisation de pelouses artificielles en Coupe du monde n'a jamais été mise en œuvre.

Ces éléments mettent en lumière les évolutions règlementaires et techniques du football au fil du temps.
```

### Run 2

```
Le texte fournit des informations sur l'histoire et les règles du football, y compris l'évolution de l'arbitrage, l'équipement des joueurs, et les changements dans les stades et les terrains de jeu. Voici des réponses aux questions posées :

1. **Règles générales d’effectif et d’usage des mains au football** : 
   - La règle générale d'effectif sur le terrain est de dix joueurs par équipe, y compris le gardien de but. Les joueurs ne sont pas autorisés à utiliser leurs mains pendant le jeu, sauf pour le gardien de but dans sa surface de réparation.
   - L'objectif du jeu est de marquer des buts en envoyant le ballon dans le filet de l'équipe adverse.

2. **Codification du football et fondation de la FIFA** :
   - Le football a été codifié en Angleterre en 1863 avec la fondation de la Football Association, qui a établi les premières règles du jeu.
   - La FIFA a été fondée le 21 mai 1904 à Paris, avec la participation de sept nations. L'Allemagne et la Russie ont rejoint l'année suivante.

3. **Réforme majeure de 1925 sur la règle du hors-jeu** :
   - En 1925, la règle du hors-jeu a été modifiée pour exiger que deux joueurs adverses soient situés entre le dernier défenseur et la ligne de but pour que la position soit considérée comme hors-jeu, plutôt que trois.

4. **Pelouses artificielles en phase finale de Coupe du monde** :
   - Le texte mentionne que la FIFA n'avait pas recommandé l'utilisation de pelouses artificielles jusqu'en 2001, date à laquelle les tests de certification ont été modifiés. Depuis lors, il est possible d'utiliser des terrains artificiels en phase finale de Coupe du monde, bien qu'aucun cas ne s'est produit jusqu'à présent.
   - Le Stade Loujniki de Moscou, équipé d'une pelouse artificielle certifiée par la FIFA en 2002, a été temporairement équipé d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008, illustrant la flexibilité concernant les types de surface.
```

### Run 3

```
Le football, tel que nous le connaissons aujourd'hui, a été codifié en 1863 à Londres, établissant les règles qui ont façonné le jeu. La FIFA (Fédération Internationale de Football Association) a été fondée en 1904 pour superviser et promouvoir le football à l'échelle mondiale.

Au niveau des règles spécifiques :

1. **Règle générale d’effectif et d’usage des mains au football :**
   - Chaque équipe est composée de 11 joueurs sur le terrain, y compris le gardien de but. Les joueurs de champ ne peuvent généralement pas utiliser leurs mains pour jouer le ballon, sauf pour le gardien de but qui peut utiliser ses mains dans sa surface de réparation.

2. **Objectif du jeu :**
   - L'objectif principal du football est de marquer plus de buts que l'adversaire en faisant passer le ballon dans le but adverse.

3. **Réforme majeure de 1925 concernant la règle du hors-jeu :**
   - En 1925, une réforme significative a été adoptée concernant la règle du hors-jeu. Jusqu'alors, le gardien de but pouvait être considéré comme étant en position de hors-jeu. Cette règle a été modifiée pour exempter le gardien de but de toute sanction pour hors-jeu, peu importe sa position sur le terrain.

4. **Pelouses artificielles en phase finale de Coupe du monde :**
   - Le texte mentionne que bien que la FIFA ait initialement recommandé contre l'usage des pelouses artificielles, elle ne les interdisait pas. Cependant, jusqu'à la Coupe du monde 1994 aux États-Unis, tous les stades devaient avoir une pelouse naturelle, notamment en raison des exigences de la FIFA. Les tests de certification de la FIFA ont évolué en 2001, permettant potentiellement l'utilisation de pelouses artificielles certifiées en phase finale de la Coupe du monde. Le Stade Loujniki à Moscou, bien qu'équipé d'une pelouse artificielle certifiée par la FIFA en 2002, a été doté d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008, illustrant la préférence pour les surfaces naturelles même avec l'évolution des règlements.

Ces éléments montrent l'évolution des règles du football et les adaptations aux avancées technologiques et aux exigences du jeu.
```

### Run 4

```
### Règles générales d’effectif et d’usage des mains au football

Dans le football, chaque équipe est composée de 11 joueurs sur le terrain. Parmi ces joueurs, un seul, le gardien de but, est autorisé à utiliser ses mains pour jouer le ballon, mais cela est uniquement permis dans sa propre surface de réparation. Les autres joueurs, appelés joueurs de champ, doivent utiliser leurs pieds, leur corps ou leur tête pour jouer le ballon, et ne peuvent pas utiliser leurs mains pour intercepter le ballon, sauf dans des circonstances spécifiques telles que lorsqu'ils sont derrière la ligne de but.

### Codification du football et fondation de la FIFA

Le football a été codifié en 1863 avec la création des "Laws of the Game" par l'Association Football Board (maintenant la Football Association, FA) en Angleterre. La FIFA (Fédération Internationale de Football Association) a été fondée plus tard, le 21 mai 1904, avec l'objectif de coordonner les compétitions internationales et de régir le jeu de football à l'échelle mondiale.

### Réforme majeure de 1925 sur la règle du hors-jeu

En 1925, une réforme majeure a modifié la règle du hors-jeu. Avant cette réforme, un joueur était considéré en position de hors-jeu s'il avait moins de deux adversaires (y compris le gardien) entre lui et la ligne de but adverse. La réforme a simplifié cette règle en stipulant que pour qu'un joueur soit en position de hors-jeu, il doit être à la fois plus avancé que le ballon et plus proche de la ligne de but adverse que le dernier défenseur (à l'exclusion du gardien). Cette modification a facilité la compréhension et l'application de la règle du hors-jeu pendant les matchs.

### Pelouses artificielles en phase finale de Coupe du monde

Le texte indique que, bien que la FIFA n'interdise pas officiellement l'utilisation de pelouses artificielles, elle les recommande rarement pour les phases finales de la Coupe du monde. Cependant, suite à des modifications des tests de certification de la FIFA en 2001, il est désormais possible d'utiliser des terrains avec une pelouse artificielle certifiée par la FIFA en phase finale de la Coupe du monde. Malgré cette possibilité, aucun match en phase finale de Coupe du monde n'a encore été joué sur une pelouse entièrement artificielle. Le Stade Loujniki de Moscou, qui a été équipé d'une pelouse artificielle certifiée par la FIFA en 2002, a toutefois été transformé pour accueillir une pelouse naturelle lors de la finale de la Ligue des champions de l'UEFA en 2008.
```

### Run 5

```
### Règle Générale d’Effectif et d’Usage des Mains au Football

- **Effectif :** Chaque équipe est composée de 11 joueurs, dont un doit être désigné comme gardien de but. Si le nombre de joueurs en action tombe à sept, le match continue, mais un joueur de chaque équipe doit être expulsé à chaque perte subséquente jusqu'à sept joueurs. Au-delà, le match est arrêté.
- **Usage des Mains :** Les joueurs, à l'exception du gardien de but dans sa surface, ne peuvent pas utiliser leurs mains pour toucher le ballon. Le gardien de but peut utiliser ses mains pour dégager le ballon dans le cadre des buts de son équipe.

### Codification du Football et Fondation de la FIFA

- Le football a été codifié en 1863 avec l'adoption des Lois du Jeu par l'Association Footballers' Club, qui deviendra plus tard la Fédération anglaise de football (FA).
- La FIFA (Fédération Internationale de Football Association) a été fondée le 21 mai 1904 à Paris, regroupant initialement 7 associations nationales membres.

### Réforme de 1925 sur la Règle du Hors-Jeu

- En 1925, une réforme majeure a été introduite concernant la règle du hors-jeu. Avant cette réforme, un joueur était considéré en position de hors-jeu s'il se trouvait entre l'adversaire et le but, sans qu'il y ait au moins deux adversaires entre lui et le but de son équipe. La réforme a modifié cette règle pour qu'un joueur ne soit plus considéré en hors-jeu s'il se trouve sur la même ligne que le ballon et que le dernier défenseur.

### Pelouses Artificielles en Phase Finale de Coupe du Monde

- Historiquement, les pelouses artificielles étaient interdites en phase finale de Coupe du monde. Cependant, des modifications des tests de certification de la FIFA en 2001 ont permis l'utilisation de terrains artificiels en phase finale, bien que cela n'ait jamais été mis en pratique.
- Le Stade Loujniki de Moscou, qui était équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été spécifiquement équipé d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008, illustrant cette situation.
```
...
```diff
--- /dev/fd/63	2025-10-16 14:05:31
+++ /dev/fd/62	2025-10-16 14:05:31
@@ -1,15 +1,16 @@
-Le texte aborde plusieurs aspects historiques et règlementaires du football, en particulier en ce qui concerne l'arbitrage et les équipements. Voici des réponses aux questions posées :
+Le texte fournit des informations sur l'histoire et les règles du football, y compris l'évolution de l'arbitrage, l'équipement des joueurs, et les changements dans les stades et les terrains de jeu. Voici des réponses aux questions posées :
