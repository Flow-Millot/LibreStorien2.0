# Rapport Bench KoboldCpp – texte-12000 (20251023_154824)
...
|---:|----------:|------:|------:|-------:|--------:|:------|
| 1 | 67.312206 | 2124 | 2179 | 31.55 | 32.37 | `f0240dfa59dba71d6d29a837cd64c8f425865ebd9d0faba18787ec8db2886cc3` |
| 2 | 35.476145 | 2174 | 2233 | 61.28 | 62.94 | `3d5b3e41ef060321c1870e4088282c621c6d44942a1c7bce9ad4825a26c5ece5` |
| 3 | 39.310754 | 2371 | 2433 | 60.31 | 61.89 | `a7571616bd2ea82c3b74425550b30ae3c23f24228f94741472e70241379189e7` |
| 4 | 23.755754 | 1500 | 1541 | 63.14 | 64.87 | `90b7fd958386b8a9219a3d5ccdca74972f16ae33673e84ce8a7538ef6d98ec73` |
| 5 | 23.438819 | 1478 | 1530 | 63.06 | 65.28 | `66dee7ea1633be2f8f478295f7d7ee28de870c509cbcb64db0568b4286852fda` |
...
```
### Règles et Objectifs du Football

**Règles de Base :**
- Le football met aux prises deux équipes de onze joueurs sur un terrain rectangulaire. L'objectif est de faire pénétrer un ballon dans le but adverse pour marquer des points. 
- Seul le gardien de but peut utiliser ses mains, et cela uniquement dans sa propre surface de réparation. 
- Les fautes incluent des comportements antisportifs et certains contacts interdits, avec des sanctions allant des cartons jaunes à l'expulsion (rouge).
- La règle du hors-jeu exige que les attaquants soient devant le dernier défenseur lorsqu'ils reçoivent le ballon.

**Objectifs du Jeu :**
- L'objectif principal est de marquer plus de buts que l'adversaire, ce qui peut être atteint grâce à la combinaison de passes, de dribbles et de tirs.

### Histoire et Codification

**Codification du Football :**
- Le premier code de jeu, les "Cambridge Rules", a été établi en 1848. 
- La Football Association (FA) de Londres, fondée en 1863, a formalisé davantage les règles et établi un règlement de 13 règles le 1er décembre 1863. 
...
- En 1925, le nombre de joueurs adverses devant se situer entre la ligne de but et celui qui reçoit une passe pour éviter le hors-jeu a été réduit de trois à deux. Cette réforme a eu des implications significatives en matière de tactique.

### Pelouses Artificielles et Coupe du Monde

**Pelouses Artificielles :**
- Les pelouses artificielles étaient interdites en phase finale de Coupe du Monde jusqu'à des modifications apportées aux tests de certification de la FIFA en 2001.
- Depuis lors, l'utilisation de terrains artificiels est permise, mais jusqu'à présent, aucun stade équipé d'une telle pelouse n'a été utilisé pour une finale de Coupe du Monde.
- Exemple : Le Stade Loujniki de Moscou, équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été doté d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008.
```

### Run 2

```
Le texte fournit des informations détaillées sur le football, ses règles et son évolution. Voici les réponses aux questions posées :

1. **Règles générales et objectifs du jeu** :
   - Le football met aux prises deux équipes de onze joueurs sur un terrain rectangulaire. Le but est de faire pénétrer un ballon dans le but adverse, qui mesure 7,32 m de long sur 2,44 m de hauteur.
   - Seul le gardien de but peut utiliser ses mains dans sa surface de réparation.
   - Les règles interdisent les comportements antisportifs et réglementent les contacts entre les joueurs, avec des sanctions comme les cartons jaunes et rouges.
   - Un joueur est en jeu s'il n'est pas en position de hors-jeu, ce qui nécessite qu'il soit devant le dernier défenseur au moment où la balle est jouée.
   - La durée du match est de 90 minutes, divisée en deux mi-temps de 45 minutes, avec une interruption de 15 minutes entre les périodes. En cas d'égalité, une prolongation ou des tirs au but peuvent avoir lieu.

2. **Codification du football et fondation de la FIFA** :
   - Le football a été codifié pour la première fois avec les Cambridge Rules en 1848. La Football Association (FA) a été fondée à Londres le 26 octobre 1863, et a établi un règlement de 13 règles le 1er décembre de la même année.
   - La FIFA a été fondée à Paris en 1904.

3. **Réforme majeure de 1925** :
   - La réforme de 1925 a modifié la règle du hors-jeu en réduisant de trois à deux le nombre de joueurs adverses devant se situer entre la ligne de but et celui qui reçoit une passe.

4. **Pelouses artificielles en phase finale de Coupe du monde** :
   - Initialement, la FIFA interdisait les surfaces artificielles en phase finale de Coupe du monde. Cependant, après des modifications des tests de certification en 2001, il est devenu possible d'utiliser des terrains artificiels.
   - Malgré cette possibilité, aucun stade n'a encore utilisé de pelouse artificielle pour un match de Coupe du monde. Le stade Loujniki de Moscou, bien qu'équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été doté d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008.
```
...
1. **Règles de Base :**
   - Le football oppose deux équipes de onze joueurs sur un terrain rectangulaire mesurant 90 à 120 mètres de long et 45 à 90 mètres de large.
   - L'objectif est de marquer des buts en envoyant le ballon dans les filets adverses, qui mesurent 7,32 m sur 2,44 m de hauteur.
   - Le gardien de but est le seul joueur autorisé à utiliser ses mains, mais uniquement dans sa surface de réparation.

2. **Hors-Jeu :**
   - Un joueur est en position de hors-jeu s'il se trouve devant le dernier défenseur adverse au moment où le ballon est joué, sauf s'il est dans sa propre moitié de terrain.
   - La règle du hors-jeu a été modifiée en 1925 pour exiger que deux joueurs adverses soient devant le joueur qui reçoit la passe.

3. **Fautes et Sanctions :**
   - Les fautes peuvent être sanctionnées par des coups francs, des corners, ou des penalties.
   - Les fautes graves peuvent entraîner un carton jaune (avertissement) ou rouge (expulsion).

4. **Durée du Match :**
   - Un match se déroule sur deux périodes de 45 minutes, avec une pause de 15 minutes à la mi-temps.
   - En cas de match nul après la prolongation, des tirs au but peuvent départager les équipes.

### Lois du Jeu

- Il existe 17 lois du jeu régies par l'International Board. Ces règles sont appliquées uniformément à travers le monde par la FIFA.

### Codification et Histoire

- **Codification :** Le football a été codifié pour la première fois en 1863 avec la création de la Football Association (FA) en Angleterre.
- **Fondation de la FIFA :** La Fédération Internationale de Football Association (FIFA) a été fondée en 1904 à Paris.

### Réformes Majeures

- **Réforme de 1925 :** La règle du hors-jeu fut modifiée pour nécessiter deux adversaires devant le joueur qui reçoit la passe, impactant significativement les tactiques de jeu.

### Pelouses Artificielles

- **Pelouses Artificielles en Coupe du Monde :** Initialement interdites en phase finale, la FIFA a autorisé leur utilisation à partir de 2001, suite à des tests de certification. Cependant, cette situation n'a jamais été mise en pratique lors des finales.
- **Exemple de Stade :** Le Stade Loujniki à Moscou, bien qu'équipé d'une pelouse artificielle certifiée, a été temporairement doté d'une pelouse naturelle pour accueillir la finale de la Ligue des Champions de l'UEFA en 2007-2008.
```
...
**Effectif et Usage des Mains :**
- Les équipes sont composées de onze joueurs chacune.
- Les joueurs ne doivent pas utiliser leurs mains ou bras (à l'exception du gardien de but dans sa surface de réparation).

**Objectif du Jeu :**
- Le but principal est de marquer des buts en faisant pénétrer le ballon dans le but adverse.

### Codification et Fondation de la FIFA

- **Codification :** Le football a été codifié pour la première fois en 1863 avec l'adoption des Cambridge Rules. La Football Association (FA) a joué un rôle crucial dans l'unification des règles.
- **Fondation de la FIFA :** La Fédération Internationale de Football Association (FIFA) a été fondée en 1904 à Paris.

### Réforme Majeure de 1925

- En 1925, la règle du hors-jeu a été modifiée pour réduire le nombre de joueurs adverses devant le joueur recevant le ballon de trois à deux, ce qui a eu des implications significatives sur la tactique du jeu.

### Pelouses Artificielles en Coupe du Monde

- **Réforme de la FIFA (2001) :** Les tests de certification de la FIFA ont évolué pour permettre l'utilisation de terrains artificiels en phase finale de Coupe du monde.
- **Exemple de Stade :** Le Stade Loujniki à Moscou, équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été temporairement doté d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008, illustrant la préférence pour la pelouse naturelle dans certains contextes.
```

### Run 5

```
### Règle générale d’effectif et d’usage des mains au football, et objectif du jeu

Le football est un sport opposant deux équipes de onze joueurs. Le seul joueur autorisé à utiliser ses mains et ses bras lorsque le ballon est en jeu est le gardien de but, mais uniquement dans sa surface de réparation. L'objectif du jeu est de faire pénétrer un ballon dans le but adverse.

### Codification du football et fondation de la FIFA

Le football a été codifié en 1863 avec la création de la Football Association (FA) à Londres, qui a établi les premières règles du jeu. La FIFA a été fondée plus tard, le 21 mai 1904, à Paris, avec le français comme première langue officielle.

### Réforme majeure de 1925 sur la règle du hors-jeu

En 1925, une réforme importante modifie la règle du hors-jeu en réduisant de trois à deux le nombre de joueurs adverses devant se situer entre la ligne de but et celui qui reçoit une passe.

### Pelouses artificielles en phase finale de Coupe du monde

Bien que la FIFA ait modifié ses règles en 2001 pour autoriser les terrains artificiels en phase finale de Coupe du monde, cette possibilité n'a jamais été mise en œuvre. En 2007, le Stade Loujniki de Moscou, équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été aménagé avec une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008.

Ces éléments soulignent les évolutions et les particularités historiques et règlementaires du football.
```
...
```diff
--- /dev/fd/63	2025-10-23 15:51:34
+++ /dev/fd/62	2025-10-23 15:51:34
@@ -1,31 +1,19 @@
-### Règles et Objectifs du Football
+Le texte fournit des informations détaillées sur le football, ses règles et son évolution. Voici les réponses aux questions posées :
