# Rapport Bench KoboldCpp – texte-12000 (20251023_145534)
...
|---:|----------:|------:|------:|-------:|--------:|:------|
| 1 | 73.359432 | 1873 | 1924 | 25.53 | 26.23 | `243574700b69957788b0f75a902eb7969a6f55acd0568a94c6d0b1d3ac8cc01d` |
| 2 | 44.879223 | 2211 | 2275 | 49.27 | 50.69 | `56809ae770a4d38d4fb6ebddddb2e8663244c46d3da800a56d43079d115721a7` |
| 3 | 40.706528 | 2081 | 2141 | 51.12 | 52.60 | `b368925c450650a348f15ecc3d638b3c484255c53ca3ee5ab601ac30378bd17b` |
| 4 | 46.479669 | 2326 | 2379 | 50.04 | 51.18 | `9e9a315774c8b53ec771e7905f9089e9d3f2f647b95151aa157c4751f9e98354` |
| 5 | 23.674447 | 1219 | 1262 | 51.49 | 53.31 | `232aca08f156da6a9172715343d4db6f977752183fb275251389e1230ac3658f` |
...
```
### Règles générales et objectifs du football

- **Règle d’effectif** : Chaque équipe est composée de onze joueurs, y compris le gardien de but. Les joueurs sont répartis en défense, milieu de terrain et attaque.
- **Usage des mains** : Seul le gardien de but peut utiliser ses mains, mais uniquement dans sa surface de réparation.
- **Objectif du jeu** : L’objectif est de marquer plus de buts que l’adversaire en faisant pénétrer un ballon dans le but adverse.

### Codification et fondation de la FIFA

- **Codification du football** : Le football a été codifié en 1863 avec la fondation de la Football Association (FA) en Angleterre. Les premiers règlements, connus sous le nom de "Cambridge Rules", ont été établis en 1848.
- **Fondation de la FIFA** : La Fédération Internationale de Football Association (FIFA) a été fondée en 1904 à Paris, avec le français comme première langue officielle.

### Réforme majeure de 1925

- **Règle du hors-jeu** : En 1925, la règle du hors-jeu a été modifiée pour exiger que trois joueurs adverses se situent entre le dernier défenseur et le joueur recevant la passe, au lieu de deux auparavant. Cette réforme a eu des implications importantes sur la tactique du jeu.

### Pelouses artificielles en phase finale de Coupe du monde

- **Usage des pelouses artificielles** : Historiquement, la FIFA ne recommandait pas l’utilisation de pelouses artificielles en phase finale de Coupe du monde. Cependant, après des modifications des tests de certification en 2001, l'utilisation de pelouses artificielles est devenue possible.
- **Illustration par le Stade Loujniki** : Malgré sa pelouse artificielle certifiée par la FIFA depuis 2002, le Stade Loujniki de Moscou a été équipé d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008, montrant la préférence persistante pour la pelouse naturelle.
```

### Run 2

```
Le football, également appelé football association, est un sport collectif et opposant deux équipes de onze joueurs chacune. Le terrain est rectangulaire, mesurant entre 90 et 120 mètres de longueur et 45 à 90 mètres de largeur. L'objectif du jeu est de marquer des buts en faisant pénétrer un ballon sphérique dans le but adverse, qui mesure 7,32 mètres de long sur 2,44 mètres de hauteur.

### Règles du Jeu :
- **Effectif** : Chaque équipe est composée de onze joueurs, dont un seul, le gardien de but, peut utiliser ses mains et ses bras lorsque le ballon est en jeu, mais seulement dans sa surface de réparation.
- **Hors-jeu** : La règle du hors-jeu exige qu'un joueur soit devant le dernier défenseur adverse au moment où il reçoit le ballon, sauf s'il est derrière la ligne de but.
- **Déroulement du match** : Le match dure 90 minutes, réparties en deux mi-temps de 45 minutes chacune, avec une pause de 15 minutes entre les deux. En cas d'égalité, des prolongations de deux fois quinze minutes peuvent être jouées, suivies de tirs au but si nécessaire.

### Codification et Histoire :
- **Codification** : Le football a été codifié pour la première fois par la Football Association (FA) à Londres en 1863. Les règles de Cambridge, adoptées en 1848, ont influencé ces premières règles.
- **FIFA** : La Fédération Internationale de Football Association (FIFA) a été fondée en 1904 à Paris.

### Réforme de 1925 :
- En 1925, la règle du hors-jeu a été modifiée pour exiger la présence de seulement deux joueurs adverses (au lieu de trois précédemment) entre le joueur qui reçoit le ballon et la ligne de but pour qu'il ne soit pas en position de hors-jeu. Cette réforme a eu des implications tactiques majeures.

### Pelouses Artificielles en Coupe du Monde :
- Historiquement, les surfaces de jeu pour les phases finales de la Coupe du Monde étaient naturelles. Cependant, après des modifications des tests de certification de la FIFA en 2001, l'utilisation de pelouses artificielles a été autorisée. Le Stade Loujniki de Moscou, malgré sa pelouse artificielle certifiée par la FIFA depuis 2002, a été équipé d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA en 2008.
```

### Run 3

```
### Règle Générale d’Effectif et d’Usage des Mains

Au football, chaque équipe est composée de onze joueurs, y compris un gardien de but. Les seuls joueurs autorisés à utiliser leurs mains et bras sont les gardiens de but, mais seulement dans leur surface de réparation. Les autres joueurs commettent une faute s'ils touchent le ballon de leurs mains ou bras, sauf en cas de certaines circonstances autorisées par les règles, comme un ballon arrêté par un auto-penalité.

### Objectif du Jeu

L'objectif principal du football est de faire pénétrer le ballon dans le but adverse plus de fois que l'adversaire ne le fait dans le but défendu. Le match se joue sur un terrain rectangulaire, et le but est marqué lorsque le ballon traverse entièrement la ligne de but située entre les poteaux du but adverse.

### Codification du Football et Fondation de la FIFA

Le football a été codifié pour la première fois en 1863 lorsque la Football Association (FA) a été fondée à Londres. La FIFA, quant à elle, a été fondée en 1904 à Paris.

### Réforme Majeure de 1925 sur la Règle du Hors-jeu

En 1925, une réforme importante a modifié la règle du hors-jeu en passant de trois à deux le nombre de joueurs adverses devant se situer entre la ligne de but et le joueur qui reçoit une passe. Cette modification a eu d'importantes implications tactiques pour le jeu.

### Pelouses Artificielles en Phase Finale de Coupe du Monde

Le texte indique que bien que les pelouses artificielles soient devenues plus acceptées au fil du temps, notamment après les modifications des tests de certification de la FIFA en 2001, elles n'ont jamais été utilisées en phase finale de Coupe du monde. L'exemple donné concerne le Stade Loujniki de Moscou, qui, bien qu'équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été doté d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008.

Ces éléments soulignent l'évolution des règles et des infrastructures dans le football tout en préservant certaines traditions et en s'adaptant aux exigences modernes.
```

### Run 4

```
Le football, dont les règles ont été codifiées pour la première fois en 1863 par la Football Association (FA) en Angleterre, est un jeu qui se joue avec un ballon sphérique. Les équipes se composent chacune de onze joueurs, y compris un gardien de but, et l'objectif est de marquer des buts en faisant entrer le ballon dans le but adverse. Le jeu se déroule sur un terrain rectangulaire avec des dimensions variables.

### Règles Générales du Football

1. **Composition et Utilisation des Mains** :
   - Seul le gardien de but peut utiliser ses mains, mais uniquement dans sa surface de réparation.
   - Les autres joueurs n'ont pas le droit d'utiliser leurs mains pour jouer le ballon.

2. **Objectif du Jeu** :
   - L'objectif est de marquer plus de buts que l'adversaire en faisant pénétrer le ballon dans le but adverse.

3. **Codification et Fondation de la FIFA** :
   - Le football a été officiellement codifié en 1863.
   - La FIFA (Fédération Internationale de Football Association) a été fondée le 21 mai 1904.

### Règle du Hors-Jeu et Réforme de 1925

- Avant 1925, un joueur était en hors-jeu s'il se trouvait devant le dernier défenseur adverse et qu'il y avait moins de deux joueurs adverses entre lui et la ligne de but. La réforme de 1925 a simplifié cette règle en demandant que trois joueurs adverses se trouvent entre le joueur en position de hors-jeu et la ligne de but (le joueur ne doit pas être le plus proche de sa propre ligne de but par rapport aux deux joueurs adverses les plus proches).

### Pelouses Artificielles en Coupe du Monde

- Initialement, la FIFA interdisait l'utilisation de pelouses artificielles pour les phases finales de la Coupe du monde. Cependant, après des modifications des critères de certification en 2001, l'utilisation de pelouses artificielles a été autorisée.
- Néanmoins, il n'y a jamais eu de phase finale de Coupe du monde disputée sur une pelouse entièrement artificielle. Par exemple, le Stade Loujniki de Moscou, équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été doté d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA en 2008.

Ces éléments illustrent l'évolution des règles et des pratiques dans le football, reflétant des adaptations à des considérations techniques, tactiques et de rendu télévisuel.
```
...
Au football, chaque équipe est composée de onze joueurs sur un terrain rectangulaire. Le seul joueur autorisé à utiliser ses mains est le gardien de but, et uniquement lorsqu'il se trouve dans sa surface de réparation. L'objectif du jeu est de faire pénétrer un ballon dans le but adverse pour marquer des points.

### Quand le football a-t-il été codifié et quand la FIFA a-t-elle été fondée ?

Le football a été codifié pour la première fois en 1863 par la fondation de la Football Association (FA) à Londres. La FIFA a été fondée en 1904 à Paris.

### Que dit le texte sur l’usage de pelouses artificielles en phase finale de Coupe du monde et quel stade illustre cette situation ?

Bien que la FIFA ait modifié ses tests de certification pour autoriser l'utilisation de pelouses artificielles en phase finale de Coupe du monde depuis 2001, cela n'a jamais été appliqué en pratique. Cependant, le Stade Loujniki de Moscou, équipé depuis 2002 d'une pelouse artificielle certifiée par la FIFA, a été remplacé par une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008.
```
...
```diff
--- /dev/fd/63	2025-10-23 14:59:24
+++ /dev/fd/62	2025-10-23 14:59:24
@@ -1,19 +1,16 @@
-### Règles générales et objectifs du football
+Le football, également appelé football association, est un sport collectif et opposant deux équipes de onze joueurs chacune. Le terrain est rectangulaire, mesurant entre 90 et 120 mètres de longueur et 45 à 90 mètres de largeur. L'objectif du jeu est de marquer des buts en faisant pénétrer un ballon sphérique dans le but adverse, qui mesure 7,32 mètres de long sur 2,44 mètres de hauteur.
