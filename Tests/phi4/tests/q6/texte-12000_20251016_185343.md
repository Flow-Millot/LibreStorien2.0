# Rapport Bench KoboldCpp – texte-12000 (20251016_185343)
...
**Fichier :** `prompt-texte-12000.txt`
...
|---:|----------:|------:|------:|-------:|--------:|:------|
| 1 | 56.072823 | 2699 | 2768 | 48.13 | 49.36 | `59814306a66dddab8415cdc374ff0e7fa59e790e1067990e8819ac3f0e4edc42` |
| 2 | 29.345441 | 1792 | 1840 | 61.07 | 62.70 | `8224442975127afd0c52a44196aa79a019c123ef1f0a248345772562d4f8be76` |
| 3 | 32.207542 | 2021 | 2077 | 62.75 | 64.49 | `edc4753ba8480facb0c7126573231be0a5bbd62a43888d92f5e03707597912a1` |
| 4 | 36.999739 | 2395 | 2448 | 64.73 | 66.16 | `ecbabe3be679dca4a9feee2ffbf55138a3ce29ba86afd855a56babb72ff62ed5` |
| 5 | 36.648454 | 2177 | 2235 | 59.40 | 60.98 | `3548e2a8f2acf02a70d83ee42935dcb493dfd2ef48f9ec401cfeaa605fb50a3d` |
...
```
### Règles Générales du Football

1. **Règle Générale d’Effectif** : Une équipe de football se compose de onze joueurs, y compris un gardien de but. Il est possible de remplacer certains joueurs sur blessure ou pour des raisons tactiques, mais cela doit se faire selon les règles du jeu (coup franc, changement à la mi-temps, etc.).

2. **Usage des Mains** : En général, les joueurs ne peuvent pas utiliser leurs mains durant le jeu, à l'exception du gardien de but qui est autorisé à utiliser ses mains dans sa propre surface de réparation. Toute utilisation des mains par un joueur autre que le gardien de but dans sa surface de réparation est sanctionnée d'un pénalty pour l'équipe adverse.

3. **Objectif du Jeu** : L'objectif principal du football est de marquer plus de buts que l'adversaire dans le temps réglementaire d'un match (deux mi-temps de 45 minutes chacune). Le but est marqué lorsque la balle entière passe entre les poteaux de but et sous la barre transversale de l'équipe adverse.

### Codification et Fondation de la FIFA

- **Codification du Football** : Le football a été codifié en 1863 avec la création de la Football Association (FA) en Angleterre. Cette codification incluait la définition des règles du jeu, telles que les dimensions du terrain, le nombre de joueurs par équipe, et les règles de jeu.

- **Fondation de la FIFA** : La Fédération Internationale de Football Association (FIFA) a été fondée le 21 mai 1904 à Paris, avec pour objectif de gérer et de développer le football à l'échelle mondiale.

### Réforme Majeure de 1925

- **Modification de la Règle du Hors-jeu** : En 1925, une réforme significative a été apportée à la règle du hors-jeu. Auparavant, un joueur était en position de hors-jeu s'il y avait moins de deux adversaires entre lui et le gardien de but. La réforme a changé cela pour qu'il n'y ait qu'un adversaire nécessaire entre le joueur et le gardien de but pour qu'il ne soit pas en hors-jeu.

### Pelouses Artificielles en Phase Finale de Coupe du Monde

- **Usage des Pelouses Artificielles** : Initialement, les pelouses artificielles étaient interdites en phase finale de la Coupe du Monde. Cependant, après des modifications des tests de certification de la FIFA en 2001, les pelouses artificielles certifiées par la FIFA ont été autorisées pour ces phases finales.

- **Illustration par le Stade Loujniki** : Bien que le Stade Loujniki de Moscou soit équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, il a été temporairement doté d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA en 2008, soulignant la préférence pour les pelouses naturelles dans les matchs de grande envergure.
```
...
1. **Règle générale d’effectif et d’usage des mains au football, et objectif du jeu :**
   - L'effectif minimum pour chaque équipe est de sept joueurs, y compris un gardien de but. L'objectif du jeu est de faire entrer le ballon dans le but de l'adversaire en le frappant avec n'importe quelle partie du corps sauf les mains et les bras, à l'exception du gardien de but dans sa surface de réparation.

2. **Codification du football et fondation de la FIFA :**
   - Le football a été codifié en 1863 avec la fondation de la Football Association en Angleterre. La FIFA (Fédération Internationale de Football Association) a été fondée en 1904.

3. **Réforme majeure de 1925 modifiant la règle du hors-jeu :**
   - En 1925, la règle du hors-jeu a été modifiée pour simplifier sa compréhension et son application. Auparavant, un joueur était considéré en position de hors-jeu s'il était situé entre le dernier défenseur et le but adverse. La réforme a stipulé qu'un joueur n'est en position de hors-jeu que s'il est plus proche du but adverse que le ballon et l'avant-dernier défenseur, sauf s'il est dans sa moitié de terrain.

4. **Usage de pelouses artificielles en phase finale de Coupe du monde et exemple de stade :**
   - Le texte mentionne que l'utilisation de pelouses artificielles était interdite en phase finale de Coupe du monde jusqu'à ce que les tests de certification de la FIFA soient modifiés en 2001. Cependant, le Stade Loujniki de Moscou, bien qu'équipé d'une pelouse artificielle certifiée, a été équipé d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008. Cela illustre l'utilisation rare de pelouses artificielles en phase finale de Coupe du monde malgré leur certification par la FIFA.
```

### Run 3

```
Le texte aborde plusieurs aspects du football, notamment les règles, l'histoire, l'équipement et les stades. Voici les réponses aux questions posées :

1. **Règle générale d’effectif et d’usage des mains au football, et objectif du jeu :**
   - L'effectif général d'une équipe est de onze joueurs, dont un gardien de but, assisté de sept remplaçants. Tous les joueurs, à l'exception du gardien de but, doivent respecter la règle de ne pas utiliser leurs mains pour jouer le ballon, sauf le gardien dans sa surface de réparation. L'objectif du jeu est de marquer des buts en envoyant le ballon dans le filet adverse.

2. **Codification du football et fondation de la FIFA :**
   - Le football a été codifié par les Football Associations de Sheffield et d'Édimbourg en 1863. La FIFA (Fédération Internationale de Football Association) a été fondée en 1904.

3. **Réforme majeure de 1925 modifiant la règle du hors-jeu :**
   - En 1925, une réforme majeure a changé la règle du hors-jeu en diminuant le nombre de joueurs adverses nécessaires devant le ballon pour qu'un joueur soit en position de hors-jeu, passant de trois à deux.

4. **Pelouses artificielles en phase finale de Coupe du monde et exemple de stade :**
   - Historiquement, les terrains de la phase finale de la Coupe du monde de la FIFA étaient exclusivement en pelouse naturelle. Cependant, après des modifications des tests de certification en 2001, il est devenu possible d'utiliser des terrains artificiels. Bien que la FIFA autorise désormais ce type de surface, elle n'a jamais été utilisé pour les finales de Coupe du monde. Le Stade Loujniki de Moscou, équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été transformé en pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA en 2008, ce qui illustre la préférence pour la pelouse naturelle dans les événements majeurs.

Ces éléments fournissent un aperçu des règles et de l'histoire du football, ainsi que des évolutions concernant les surfaces de jeu.
```

### Run 4

```
Le football, tel que nous le connaissons aujourd'hui, a été codifié en 1863 par la Football Association en Angleterre. Cette codification a permis de formaliser les règles du jeu, y compris celles concernant l'effectif et l'usage des mains. À l'origine, il existait deux variantes principales : le « football association » (FA), où l'usage des mains était strictement interdit, et le « rugby football », où les joueurs pouvaient utiliser leurs mains pour attraper la balle. Le choix du football association a conduit à la règle générale actuelle, où les joueurs, à l'exception du gardien de but dans sa surface de réparation, ne peuvent pas utiliser leurs mains pour jouer la balle. L'objectif principal du jeu est de marquer plus de buts que l'adversaire en envoyant le ballon dans son but en utilisant principalement les pieds, bien que d'autres parties du corps puissent être utilisées.

La FIFA, la Fédération Internationale de Football Association, a été fondée en 1904. Elle est devenue l'organisme dirigeant mondial du football, responsable de la régulation des règles du jeu et de l'organisation des compétitions internationales, notamment la Coupe du monde.

En 1925, une réforme majeure a modifié la règle du hors-jeu. Initialement, la règle exigeait qu'au moins trois adversaires se trouvent entre le joueur et le but pour qu'il ne soit pas en position de hors-jeu. La réforme de 1925 a réduit ce nombre à deux, ce qui a rendu le jeu plus rapide et plus ouvert en permettant plus de joueurs d'attaquer le but.

Concernant l'usage des pelouses artificielles, le texte mentionne que la FIFA a interdit leur utilisation en phase finale de Coupe du monde jusqu'en 2001. Après la modification des tests de certification de la FIFA en 2001, il est devenu possible d'utiliser des terrains artificiels en phase finale. Cependant, aucun stade en phase finale n'a effectivement utilisé ce type de surface jusqu'à présent. Par exemple, lors de la Coupe du monde 1994 aux États-Unis, malgré l'installation de pelouses artificielles dans plusieurs stades tels que le Pontiac Silverdome et le Giants Stadium, tous ont été convertis en pelouse naturelle pour la compétition. De même, le Stade Loujniki de Moscou, bien qu'équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été équipé d'une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA 2007-2008.
```
...
1. **Règle Générale d’Effectif** : 
   - Chaque équipe se compose de 11 joueurs maximum, y compris le gardien de but. Cependant, en cas de manque de joueurs en raison de blessures ou d'expulsions, le match peut se poursuivre tant que chaque équipe a 7 joueurs présents.

2. **Usage des Mains** : 
   - Selon les règles, les joueurs ne peuvent généralement pas utiliser leurs mains lors du jeu, excepté le gardien de but dans sa propre surface de réparation.

3. **Objectif du Jeu** : 
   - Le but principal est de marquer plus de buts que l'adversaire en faisant rentrer le ballon dans le but adverse.

### Codification et Fondation de la FIFA

- **Codification du Football** : 
  - Le football a été codifié en 1863 avec la création des Lois du Jeu par l'Association Football à Londres.
  
- **Fondation de la FIFA** :
  - La FIFA a été fondée en 1904 à Paris, avec l'objectif de réguler et promouvoir le football à l'échelle internationale.

### Réforme de 1925

- **Réforme Majeure** :
  - En 1925, la règle du hors-jeu a été modifiée pour rendre le jeu plus fluide. La règle précédente exigeait qu'un adversaire du joueur qui reçoit le ballon soit plus proche de la ligne de but adverse que lui-même. La réforme a permis qu'un joueur ne soit pas en position de hors-jeu même s'il est en avant de la dernière défenseur, tant qu'il n'est pas entre ce dernier et le but.

### Pelouses Artificielles en Phase Finale de Coupe du Monde

- **Texte sur Pelouses Artificielles** :
  - Initialement, les pelouses artificielles étaient interdites en phase finale de la Coupe du Monde. Cependant, après des modifications des tests de certification de la FIFA en 2001, les stades équipés de pelouses artificielles certifiées sont devenus éligibles.

- **Stade Illustrant cette Situation** :
  - Le Stade Loujniki de Moscou, qui est équipé d'une pelouse artificielle certifiée par la FIFA depuis 2002, a été spécifiquement aménagé avec une pelouse naturelle pour accueillir la finale de la Ligue des champions de l'UEFA en 2008, soulignant le fait que les pelouses artificielles ne sont pas encore couramment utilisées en phase finale de Coupe du Monde.
```
...
```diff
--- /dev/fd/63	2025-10-16 18:56:54
+++ /dev/fd/62	2025-10-16 18:56:54
@@ -1,23 +1,13 @@
-### Règles Générales du Football
+Voici les réponses aux questions posées :
